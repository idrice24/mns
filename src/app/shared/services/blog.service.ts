...
export class BlogService {
  ...
  addBlog(Topic: Topic): Observable<Topic> {
    return this.httpClient.post<Topic>(this.blogUrl, Topic, this.httpOptions).pipe(
      tap((newBlog: Topic) => this.log(`added Blog w/ id=${newBlog.id}`)),

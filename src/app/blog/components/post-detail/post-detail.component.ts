...
export class PostDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.blogService.getAppComment().subscribe(i => this.appCommentList = i);
...
// still under proceed wting for the service files
  // createComment(commentForm){
  //   if(commentForm.valid){
  //     const created = this.blogService.createComment( this.comment );
  //     if(created){
  //       this.message = '' + this.counter++;
  //       this.comment = new Comment('', 0, '',);
  //     }else{
  //       this.message = 'Not commented!!';
  //     }
  //   }else{
  //     console.error('Comments had a problem!!');
  //   }
  // }
